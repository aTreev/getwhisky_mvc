...
function loadMoreProducts() 
{
    ...
    if ($category->getProductsByOffsetLimit($offset, $limit, $sortOption)) {
        $html = $category->getView()->productsOnly();
        echo json_encode(['html' => $html, 'newOffset' => $offset+$limit, 'end_of_products' => false]);
    } else {
        echo json_encode(['html' => "", 'newOffset' => $offset+$limit, 'end_of_products' => true]);
    }
}
